...
def get_fasting_keyboard() -> InlineKeyboardMarkup:
    ...
    builder.add(InlineKeyboardButton(text="✅ Восполнил пост", callback_data="fast_completed"))
    builder.add(InlineKeyboardButton(text="➕ Пропустил пост", callback_data="fast_missed"))
