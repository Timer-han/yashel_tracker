...
async def confirm_registration(callback: CallbackQuery, state: FSMContext):
    ...
    if success:
        ...
        await callback.message.answer(
            ...
            "Как разобраться в процессе восполнения поклонений, мы рассказываем в нашем канале (https://t.me/qazaatracker)\n\n"
            "Изучи информацию и возвращайся ко мне 😁\n\n"
            "Теперь можешь приступить к расчету пропущенных намазов и постов)\n\n"
            f"{welcome_text}\n",
